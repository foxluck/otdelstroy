...
function settingCONF_BYCOUNTRY_BYZONE_PERCENT_FORM($module_id)
{
	...
	if(!$curr_country){
		...
		$curr_country = xGetData('SXshipping_module_bycountry_byzone_countryPERC'.$module_id);
	}
	xSaveData('SXshipping_module_bycountry_byzone_countryPERC'.$module_id,$curr_country);
	...
	$res .= "</select></td>";
	$res .= "<td><input type=submit name=save value=\"".CSHIPPINGMODULEBYCOUNTRYBYZONEPERCENT_TXT_2."\"></td>\n";
	$res .= "</tr>\n";
