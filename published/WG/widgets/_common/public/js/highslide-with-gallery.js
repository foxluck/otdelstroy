...
skin : {
	controls:
		'<div class="highslide-controls"><ul>'+
			...
			'</li>'+
			'<li class="highslide-full-expand" style="display: none;">'+
...
getControls: function() {
	...
	for (var i = 0; i < hs.buttonsDisable.length; i++)
		this.btn[ hs.buttonsDisable[i] ].style.display = 'none';
},
